# BilingualText
A simple python script that translates english text to japanese with furigana. 

The main goal is to help get acustomed to reading kanjis. Obviusly ther will be some problems with text matching, but i guess it 85% accurate so you can use it as a training wheels and later switch to normal japanese content.
